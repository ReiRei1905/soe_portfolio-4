document.addEventListener("DOMContentLoaded", function () {
    ...
    input.addEventListener('input', function() {
        ...
        // Policy checks
        if (value.length < 12) messages.push("At least 12 characters");
        if (!/[A-Z]/.test(value)) messages.push("1 uppercase letter");
        if (!/[a-z]/.test(value)) messages.push("1 lowercase letter");
        if (!/[0-9]/.test(value)) messages.push("1 number");
        if (!/[!@#$%^&*()_+\-=\[\]{};':\"\\|,.<>\/?`~]/.test(value)) messages.push("1 special character");
